              ...
              R$ <?php echo number_format($item['price'], 2, ',', '.'); ?>
        		...
        		<td>
        			<div class="btn-group">
						...
						<a href="<?php echo BASE_URL.'products/del/'.$item['id']; ?>" onclick="return confirm('Tem certeza que deseja EXCLUIR esse produto ?')" class="btn btn-xs btn-danger">Excluir</a>
					</div>
        		</td>
        	</tr>
        <?php endforeach; ?>
